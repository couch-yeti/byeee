...
from common.langchain_schema import BaseModel, Validation, Itinerary, PointsOfInterest
...
class ValidationTemplate(BaseTemplate):
    def __init__(self):
        ...
        {format_instructions}
        """
        super().__init__(pydantic_object=Validation)
...
class POITemplate(BaseTemplate):
    ...
    def __init__(self, **kw):
        ...
        {format_instructions}
        """
        super().__init__(pydantic_object=PointsOfInterest)
...
class ItineraryTemplate(BaseTemplate):
    ...
    def __init__(self):
        ...
        {format_instructions}
        """
        super().__init__(pydantic_object=Itinerary)
